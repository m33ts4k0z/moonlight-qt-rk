...
This is tested on Armbian 25.8.1 using vendor kernel 6.1.115 and specifically Gnome 46 using the blob g24p0-wayland-gbm. Both the blob and this fork work only on wayland.
